...
public class StudentListAdapter
  extends RecyclerView.Adapter<StudentItemVieHolder> {
  ...
  @NonNull
  @Override
  public StudentItemVieHolder onCreateViewHolder(
  ...
  public void onBindViewHolder(
    @NonNull StudentItemVieHolder holder,
    int position
  ) {
    ...
    holder.tvCourseSubject.setText(
      "Course: " + s.getCourse() + " Subject: " + s.getSubject()
    );
