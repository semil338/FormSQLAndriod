...
public class SecondFormActivity extends AppCompatActivity {
    ...
    Spinner spSubject;
    ActivityResultLauncher<Intent> selectIDCardResultLauncher = registerForActivityResult(new ActivityResultContracts.StartActivityForResult(), result -> {
    ...
    private void setSubjectDropdown() {
        ...
        ArrayAdapter adapter = new ArrayAdapter(this, R.layout.dropdown_item, subjects);
        ...
        mBtnSubmit.setOnClickListener(v -> {
            if (selectedImageUri == null) {
                ...
                if (id != -1) {
                    ...
                    Intent intent = new Intent(SecondFormActivity.this, DisplayActivity.class);
