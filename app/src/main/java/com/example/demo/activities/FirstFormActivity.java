...
public class FirstFormActivity extends AppCompatActivity {
  ...
  private void validateFields() {
    Objects
      .requireNonNull(mWrapperEmail.getEditText())
    ...
    Objects
      .requireNonNull(mWrapperFName.getEditText())
      .addTextChangedListener(
        new TextWatcher() {
          @Override
          public void beforeTextChanged(
    ...
    Objects
      .requireNonNull(mWrapperLName.getEditText())
      .addTextChangedListener(
        new TextWatcher() {
          @Override
          public void beforeTextChanged(
    ...
    Objects
      .requireNonNull(mWrapperAddress.getEditText())
      .addTextChangedListener(
        new TextWatcher() {
          @Override
          public void beforeTextChanged(
    ...
    Objects
      .requireNonNull(mWrapperMobile.getEditText())
      .addTextChangedListener(
        new TextWatcher() {
          @Override
          public void beforeTextChanged(
  ...
  private void setClickListeners() {
    ...
    mBtnNext.setOnClickListener(v -> {
      if (
        ...
        String gender = mRbMale.isChecked()
          ? mRbMale.getText().toString()
          : mRbFemale.getText().toString();
